    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4 text-white">User Information</h6>
                           ...
                           <form method="POST" action="submit.php" enctype="multipart/form-data">
                                ...
                                <!-- Bio -->
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" name="bio" style="height: 150px;" required></textarea>
                                    <label>Bio</label>
                                </div>
                                <!-- Submit -->
                ...
                <div class="col-sm-12 col-xl-6">
                    <form method="POST" action="edu.php" enctype="multipart/form-data">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <input type="text" class="form-control" name="year_graduated" placeholder="Year Graduated" required>
                    </div>

                    <hr class="text-light">

                    <h6 class="mb-4">Work Experience</h6>
                    ...
                    <input type="text" class="form-control" name="duration" placeholder="Duration (e.g., Jan 2020 - Dec 2023)" required>
                    </div>

                    <!-- Description -->
                    <div class="input-group mb-3">
                    <span class="input-group-text"><i class="fas fa-align-left"></i></span>
                    <textarea class="form-control" name="description" placeholder="Job Description" rows="3" required></textarea>
                    </div>
